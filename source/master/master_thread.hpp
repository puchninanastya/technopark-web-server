...
namespace monzza {
    namespace master {
        ...
        class MasterThread : public monzza::logger::LogFunctionality {
        public:
            MasterThread();
            ~MasterThread();

            bool initialize( monzza::logger::Logger* logger, MasterSettings* masterSettings );
        ...
        private:
            ...
            std::map<uint32_t, std::pair<monzza::worker::Worker*, monzza::worker::WorkerSettings*>> workers_;
